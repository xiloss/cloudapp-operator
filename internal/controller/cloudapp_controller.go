...
// +kubebuilder:rbac:groups=apps.xiloss.com,resources=cloudapps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=apps.xiloss.com,resources=cloudapps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=apps.xiloss.com,resources=cloudapps/finalizers,verbs=update
